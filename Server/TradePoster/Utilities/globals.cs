...
namespace TradePoster.Utilities
{
    public static class globals
    {
        #region CONSTANTS
        public static string SERVER_URL = "https://tradeposter.dselectricstore.com";
        public static string FACEBOOK_SOURCE = "Facebook";
        public static string GMAIL_SOURCE = "Gmail";
        public static string DEFAULT_SOURCE = "Manual";
        public static string FEATURE_LISTING = "Feature";
        ...
        public static AuthToken ReadJWT_Token(string token)
        {
            try
            {
                ...
                {
                    UserId = tokenS.Claims.FirstOrDefault(x => x.Type.Equals("nameid"))?.Value,
